...
%{--    <g:render template="configsGrid" model="['isMediationProcessRunning': isMediationProcessRunning,
...
<g:preferenceIsNullOrEquals preferenceId="${Constants.PREFERENCE_USE_JQGRID}" value="0">
    <g:render template="ediTypes" model="['ediTypes': ediTypes, selected:selected]"/>
