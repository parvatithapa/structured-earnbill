...
<div class="row">
    ...
    <a class="toolTipElement price-model-help" onclick="openHelpDialog('${planIndex + type?.name() + modelIndex}');"title="${message(code: 'price.strategy.COMMON.pricing.help.tooltip.message')}">
    </a>
</div>
