...
<div class="row">
    <label class="toolTipElement" title="<g:message code="price.strategy.COMMON.pricing.tooltip.message"/>" for="model.${modelIndex}.type">
        <g:message code="plan.model.type"/>
    </label>
    <g:applyLayout name="form/select_holder">
        <content tag="include.script">true</content>
        <content tag="label.for">model.${modelIndex}.type</content>
        <g:select               name = "model.${modelIndex}.type"
                                class = "model-type toolTipElement"
    ...
    <a   class = "price-model-help toolTipElement"
         onclick = "openHelpDialog('${planIndex}${type?.name()}${modelIndex}');"
         title = "${message(code: 'price.strategy.COMMON.pricing.help.tooltip.message')}"></a>
</div>
