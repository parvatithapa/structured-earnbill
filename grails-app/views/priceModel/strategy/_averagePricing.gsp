...
<div class="row">
    ...
    <a class="price-model-help toolTipElement" onclick="openHelpDialog('${planIndex + type?.name() + modelIndex}');"title="${message(code: 'price.strategy.COMMON.pricing.help.tooltip.message')}" style="width: 20px;height: 20px;">
    </a>
</div>
