...
<div class="column-hold">
    ...
    <div class="box">
        <div class="sub-box">
            <table class="dataTable" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td><g:message code="account.type.config.invoiceTemplate"/></td>
                    <td class="value">${!selected?.invoiceTemplate ? '' : InvoiceTemplateDTO.get(selected.invoiceTemplate.id).name}</td>
                </tr>
                <tr>
        ...
        <div class="box">
            <div class="sub-box">
                ...
                <g:each var="ait" status="index" in="${selected.informationTypes.sort{ it.displayOrder }}">
                    ...
                    <tr>
                       <td><g:message code="prompt.use.in.notifications"/></td>
                       <td class="value">${ait.useForNotifications}</td>
                    </tr>
                    <tr>
    ...
    <div class="btn-box">
        <div class="row">
            <a href="${createLink(controller:'accountType', action:'edit', id:selected.id) }" class="submit edit button-secondary">
            ...
            <a href="${createLink(controller:'accountType', action:'listPrices', id:selected.id) }" class="submit edit">
                <span><g:message code="button.prices"/></span></a>
