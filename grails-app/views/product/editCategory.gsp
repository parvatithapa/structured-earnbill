...
<div class="form-edit">
    ...
    <g:set var="assetMgmtEnabled" value="${false}"/>
    <sec:ifAllGranted roles="PRODUCT_CATEGORY_STATUS_AND_ASSETS_53">
        <g:set var="assetMgmtEnabled" value="${true}"/>
    </sec:ifAllGranted>
    ...
    <div class="form-hold">
        <g:form name="save-category-form" action="saveCategory" useToken="true">
            ...
            <fieldset>
                <div class="form-columns">
                    <div class="column">
                        ...
                        <g:applyLayout name="form/select">
                            ...
                            <g:set var="orderLineTypes" value="${OrderLineTypeDTO.list()}"/>
                            <g:set var="orderLineTypeDisabled" value="false"/>
                            <g:if test="${!assetMgmtEnabled}">
                                <g:if test="${category?.orderLineTypeId == 5}">
                                    <g:set var="orderLineTypeDisabled" value="true"/>
                                    <g:hiddenField name="orderLineTypeId" value="${category?.orderLineTypeId}" />
                                </g:if>
                                <g:else>
                                    <g:set var="orderLineTypes" value="${orderLineTypes.findAll({it.id != 5})}" />
                                </g:else>
                            </g:if>

                            <g:select name="orderLineTypeId" from="${orderLineTypes}"
                                      optionKey="id" optionValue="description"
                                      value="${category?.orderLineTypeId}"
                                      onChange="verifyAssetManagement(this.value)" disabled="${orderLineTypeDisabled}"/>
                        ...
                        <g:applyLayout name="form/checkbox">
                            ...
                            <g:checkBox id="allowAssetManagement" class="field" name="allowAssetManagement"
                                        ...
                                        onchange="showAssetManagement()" disabled="${!assetMgmtEnabled}"/>
                            <g:if test="${!assetMgmtEnabled}">
                                <g:hiddenField name="allowAssetManagement" value="${category?.allowAssetManagement}" />
                            </g:if>
                        </g:applyLayout>
                        ...
                        <div id="assetIdentifierLabelDiv" >
                            <g:applyLayout name="form/input">
                                ...
                                <g:textField class="field" id="assetIdentifierLabel" name="assetIdentifierLabel"
                                             value="${category?.assetIdentifierLabel}" disabled="${!assetMgmtEnabled}"/>
                                <g:if test="${!assetMgmtEnabled}">
                                    <g:hiddenField name="assetIdentifierLabel" value="${category?.assetIdentifierLabel}" />
                                </g:if>
                            </g:applyLayout>
                        </div>
                ...
                <div id="assetStatuses" class="box-cards box-cards-open">
                    ...
                    <div class="box-card-hold">
                        <g:render template="/product/assetStatus" model="[statuses: orderedStatuses, isNew: isNew, assetMgmtEnabled: assetMgmtEnabled]"/>
                    </div>
                </div>
                ...
                <%-- meta fields controls --%>
                            ...
                            <g:if test="${!category?.entity || loggedInUser.companyId == category?.entity?.id}">
                                <div class="type-metafield-header">
                                    <span class="type-metafield-menu"><label for="metaFieldTemplate.id"><g:message
                                            code="button.add.metaField"/></label><a class="plus-icon"
                                    ...
                                    <span class="type-metafield-menu">
                                        ...
                                        <g:applyLayout name="form/select_holder">
                                            <content tag="label.for">metaFieldTemplate.id</content>
                                        ...
                                        <a class="plus-icon" onclick="${remoteFunction(action: 'populateMetaFieldForEdit',
                                    ...
                                    <span class="type-metafield-menu">
                                        ...
                                        <g:applyLayout name="form/select_holder">
                                            <content tag="label.for">metaFieldGroupTemplate.id</content>
                                            <content tag="holder.class">select-holder-nofloat</content>
                                        ...
                                        <a class="plus-icon" onclick="${remoteFunction(action: 'populateCategoryMetaFieldsForEdit',
                                                update: [success: 'meta-field-load-target', failure: 'meta-field-load-target'],
                                                onComplete: 'moveMetaFieldsFromTemplate()',
                    ...
                    <div class="buttons">
                        <ul>
                            <li><a onclick="submitForm()" class="submit save button-primary"><span><g:message
