...
<script type="text/javascript">
    ...
    function loadAvailableDecLang(){
        ...
        if(languages[0]!=''){
            ...
            $("#newDescriptionLanguage").each(function () {
                updateSelectLabel(this);
            });

            $("#newDescriptionLanguage").change(function () {
                updateSelectLabel(this);
            });
        }else{
            $('#addDescription').hide();
...
<div class="row" id='addDescription'>
    <div class="add-desc">
        ...
        <a class="plus-icon" onclick="addNewProductDescription()">&#xe026;</a>
    </div>
</div>
...
<div id="descriptionClone" style="display: none">
    <g:applyLayout name="form/description">
        ...
        <a class="plus-icon" onclick="removeProductDescription(this)">&#xe000;</a>
        <content tag="icon">
            <a class="delete plus-icon" onclick="removeProductDescription(this)">&#xe000;</a>
        </content>
    </g:applyLayout>
</div>
