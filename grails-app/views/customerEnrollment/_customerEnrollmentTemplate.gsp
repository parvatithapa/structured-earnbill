...
<g:preferenceEquals preferenceId="${Constants.PREFERENCE_USE_JQGRID}" value="1">
    <g:render template="customerEnrollmentGrid" model="[customerEnrollments: customerEnrollments]"/>
</g:preferenceEquals>
<g:preferenceIsNullOrEquals preferenceId="${Constants.PREFERENCE_USE_JQGRID}" value="0">
    <g:render template="customerEnrollments" model="[customerEnrollments: customerEnrollments]"/>
