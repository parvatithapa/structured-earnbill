...
<body>
        ...
        <div class="form-hold">
            <g:form name="plugin-form" action="save">
                ...
                <fieldset>
                            ...
                            <div class="row">
                                ...
                                <span>
                                    <g:applyLayout name="form/select_holder">
                                        <content tag="holder.class">plugin</content>
                    ...
                    <div class="buttons">
                        <ul>
                            <li><a class="submit save button-primary" onclick="$('#plugin-form').submit();" href="#">
    ...
    <script type="text/javascript">
        $("#typeId").change(function () {
            ...
            $.post("${createLink(controller:'plugin', action:'getTypeParametersDescriptions')}", { typeId:typeSelected },
            function (msg) {
