...
<g:preferenceEquals preferenceId="${Constants.PREFERENCE_USE_JQGRID}" value="1">
    <g:render template="ordersGrid" model="[orders: orders, processId: processId, ids: ids, mediationId: mediationId]"/>
</g:preferenceEquals>
<g:preferenceIsNullOrEquals preferenceId="${Constants.PREFERENCE_USE_JQGRID}" value="0">
    <g:render template="orders" model="[orders: orders, processId: processId, ids: ids, displayer: displayer]"/>
