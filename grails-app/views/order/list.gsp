...
<body>
    <content tag="column1">
        <g:render template="ordersTemplate" model="[orders: orders, processId: processId, ids: ids, mediationId: mediationId, displayer: displayer]"/>
    </content>
    ...
    <content tag="column2">
        <g:if test="${order}">
            <g:render template="show" model="[
                    ...
                    periodUnit: periodUnit, isCurrentCompanyOwning: isCurrentCompanyOwning, displayer: displayer]"/>
        </g:if>
    </content>
</body>
</html>
