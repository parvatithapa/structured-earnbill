...
<div class="row" id='addDescription${metaFieldIdx}'>
    <div class="add-desc">
        ...
        <g:applyLayout name="form/select_holder">
            ...
            <content tag="label.for">newDescriptionLanguage${metaFieldIdx}</content>
            <select name="newDescriptionLanguage${metaFieldIdx}" id="newDescriptionLanguage${metaFieldIdx}"></select>
        </g:applyLayout>
        <a class="plus-icon" onclick="addNewDescription('${parentId}', '${metaFieldIdx}')">
            &#xe026;
        </a>
    </div>
</div>
...
<div id="descriptionClone${metaFieldIdx}" style="display: none;">
    <g:applyLayout name="form/description">
        ...
        <content tag="icon">
            <a class="plus-icon" onclick="removeDescription(this, '${metaFieldIdx}')">&#xe000;</a>
        </content>
    ...
    <g:each in="${validationRule?.errorMessages}" var="description" status="index">
        <g:if test="${description?.languageId}">
            <g:applyLayout name="form/description">
                ...
                <content tag="icon">
                    <a class="plus-icon" onclick="removeDescription(this, '${metaFieldIdx}')">
                        &#xe000;
                    </a>
                </content>
