...
<div class="column-hold">
    ...
    <div class="box">
        <div class="sub-box">
          <table class="dataTable" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td><g:message code="language.label.countryCode"/></td>
                <td class="value">${selected.countryCode}</td>
            </tr>
            <tr>
                <td><g:message code="language.label.locale"/></td>
                <td class="value">${selected.asLocale()}</td>
            </tr>
            <tr>
    ...
    <div class="btn-box">
        <div class="row">
            <g:remoteLink action='edit' class="submit add"  update="column2" params="[id:selected.id]">
