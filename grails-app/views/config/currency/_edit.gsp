...
<div class="column-hold">
    ...
    <g:form name="save-currency-form" url="[action: 'saveCurrency']" useToken="true">
    ...
    <div class="box">
      <div class="sub-box">
        <fieldset>
            <div class="form-columns">
                ...
                <g:applyLayout name="form/input">
                    <content tag="label">
                        <g:message code="currency.config.label.name"/>
                ...
                <g:applyLayout name="form/input">
                    <content tag="label">
                        <g:message code="currency.config.label.code"/>
                        <span id="mandatory-meta-field">*</span>
                    </content>
                ...
                <g:applyLayout name="form/input">
                    <content tag="label">
                        <g:message code="currency.config.label.symbol"/>
                        <span id="mandatory-meta-field">*</span>
                    </content>
                ...
                <g:applyLayout name="form/input">
                    <content tag="label">
                        <g:message code="currency.config.label.countryCode"/>
                        <span id="mandatory-meta-field">*</span>
                    </content>
        ...
        <div class="btn-box buttons">
            <ul>
                <li><a class="submit save button-primary" onclick="$('#save-currency-form').submit();"><span><g:message code="button.save"/></span></a></li>
