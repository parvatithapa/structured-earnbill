...
<div class="form-edit">
    ...
    <div class="form-hold">
        <g:uploadForm name="save-email-form" url="[action: 'saveEmail']" useToken="true">
            <fieldset>
                <div class="form-columns">
                    <div class="column single">
                        ...
                        <g:applyLayout name="form/input">
                            <content tag="label"><g:message code="email.config.label.invoice.bundle"/></content>
                            <content tag="label.for">invoiceBundleEmail</content>
                            <g:textField name="invoiceBundleEmail" class="field" value="${invoiceBundleEmail.value}" />
                        </g:applyLayout>
                        <!-- spacer -->
                        <div>
                            <br/>&nbsp;
        ...
        <div class="btn-box buttons">
            <ul>
                <li><a onclick="$('#save-email-form').submit();" class="submit save button-primary"><span><g:message code="button.save"/></span></a></li>
