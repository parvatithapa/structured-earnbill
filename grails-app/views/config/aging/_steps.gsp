...
<%@page import="com.sapienter.jbilling.server.process.CollectionType" %>
    ...
    <div id="ageing">
        ...
        <g:hiddenField name="collectionType" value="${CollectionType.REGULAR}"/>
        <fieldset>
            <div class="form-columns single width-auto pad-left-right">
                <table id="ageingStepTable" class="innerTable pad-below">
                    ...
                    <tr>
                        ...
                        <th style="width:110px;line-height:15px;"><g:message code="config.ageing.stop.activation.on.payment"/></th>
                        <th class="last"/>
                    </tr>
                    </thead>
                    <tbody>
                    <g:each status="iter" var="step" in="${ageingSteps}">
                        <tr>
                            ...
                            <td class="medium">
                                <g:field type="number" class="inp-bg inp4" name="obj[${iter}].days" value="${step.days}"/>
                            </td>
                            <td class="tiny">
                            ...
                            <td class="tiny">
                                <g:checkBox class="cb checkbox" name="obj[${iter}].stopActivationOnPayment" checked="${step.stopActivationOnPayment }"/>
                            </td>
                            <td class="tiny">
                                <g:if test="${!step?.inUse}">
                                    <a class="plus-icon" onclick="removeAgeingStep(this, ${iter});">&#xe000;</a>
                                </g:if>
                            </td>
                        </tr>
                    </g:each>
                    ...
                    <tr>
                        ...
                        <td class="medium">
                            <g:field type="number" class="inp-bg inp4" name="obj[${newStepIndex}].days"/>
                        </td>
                        <td class="tiny">
                        ...
                        <td class="tiny">
                            <g:checkBox class="cb checkbox" name="obj[${newStepIndex}].stopActivationOnPayment" checked="${false}"/>
                        </td>
                        <td class="tiny">
                            <a class="plus-icon" onclick="addAgeingStep(this, ${newStepIndex})">&#xe026;</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <div class="btn-row buttons margins">
            <a onclick="$('#save-aging-form').submit();" class="submit save button-primary"><span><g:message code="button.save"/></span></a>
