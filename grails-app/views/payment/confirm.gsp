...
<%@ page import="com.sapienter.jbilling.server.metafields.DataType; com.sapienter.jbilling.common.Constants" contentType="text/html;charset=UTF-8" %>
...
<div class="form-edit">
    ...
    <div class="form-hold">
        <g:form name="payment-edit-form" action="save" useToken="true">
            <fieldset>
                ...
                <div class="form-columns">
                    ...
                    <div class="column">
                        ...
                        <g:applyLayout name="form/text">
                            <content tag="label"><g:message code="submit.to.payment.gateway.label"/></content>
                            <g:formatBoolean boolean="${submitToPaymentGateway}"/>
                            <g:hiddenField id="submit_to_payment_gateway_hidden" name="submitToPaymentGateway" value="${submitToPaymentGateway}"/>
                        </g:applyLayout>
                ...
                <div class="buttons">
                    <ul>
                        <li>
                            <a onclick="$('#payment-edit-form').submit()" class="submit payment button-primary">
