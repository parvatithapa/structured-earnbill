...
<div class="column-hold">
    ...
    <div class="box">
        ...
        <div class="sub-box">
            <table class="dataTable" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td><g:message code="partner.detail.broker"/></td>
                    <td class="value">${selected?.brokerId}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="value"><g:formatDate date="${selected?.baseUser.createDatetime}" formatName="date.pretty.format"  timeZone="${session['company_timezone']}"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="value"><g:formatBoolean boolean="${selected?.baseUser?.isAccountExpired()}" true="Yes" false="No"/></td>
                </tr>
    ...
    <g:if test="${!selected.deleted}">
        <div class="btn-box">
            <div class="row">
                <sec:ifAllGranted roles="AGENT_102">
                    <g:link controller="partner" action="edit" id="${selected.id}" class="submit edit button-secondary"><span><g:message code="button.edit"/></span></g:link>
                </sec:ifAllGranted>
                <sec:ifAllGranted roles="AGENT_103">
