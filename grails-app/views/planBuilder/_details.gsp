    ...
    <g:formRemote name="plan-details-form" url="[action: 'edit']" update="ui-tabs-review" method="GET">
        ...
        <div class="form-columns">
            <g:applyLayout name="form/input">
                <content tag="label"><g:message code="plan.item.internal.number"/><span id="mandatory-meta-field">*</span></content>
            ...
            <g:render template="/descriptions/descriptions" model="[product: product, itemName: 'product', form_to_submit_on_update: 'plan-details-form']"/>
            ...
            <g:applyLayout name="form/select">
                ...
                <content tag="include.script">true</content>
                <g:select name="price.currencyId" from="${CompanyDTO.get(session['company_id'] as Integer)?.currencies.sort{it.description}}"
            ...
            <g:hiddenField name="originalStartDate" value="${formatDate(date: startDate, formatName: 'datepicker.format')}"/>
            <g:if test="${plan?.id}">
                <g:applyLayout name="form/date">
            ...
            <g:else>
                <g:hiddenField name="startDate" value="${formatDate(date: startDate, formatName: 'datepicker.format')}"/>
            </g:else>


            <g:applyLayout name="form/select_multiple">
		        <content tag="label"><g:message code="product.categories"/><span id="mandatory-meta-field">*</span></content>
            ...
            <g:isGlobal>
                <g:applyLayout name="form/checkbox">
                    ...
                    <g:checkBox id="global-checkbox" onClick="hideCompanies()" class="cb checkbox" name="product.global" checked="${product?.global}"/>
                </g:applyLayout>
            </g:isGlobal>
            ...
            <div id="product-metafields">
                <g:render template="/metaFields/editMetaFields" model="[ availableFields: availableFields, fieldValues: plan?.metaFields ]"/>
            </div>
            <div>
                <g:applyLayout name="form/checkbox">
