...
<g:preferenceEquals preferenceId="${Constants.PREFERENCE_USE_JQGRID}" value="1">
    <g:render template="processesGrid" model="[processes: processes, filters:filters , processValues:processValues]"/>
</g:preferenceEquals>
<g:preferenceIsNullOrEquals preferenceId="${Constants.PREFERENCE_USE_JQGRID}" value="0">
    <g:render template="processes" model="[processes: processes, filters:filters , processValues:processValues, isMediationProcessRunning: isMediationProcessRunning]"/>
