...
<div class="column-hold">
    ...
    <g:form id="save-period-form" name="order-period-form" url="[action: 'save']" useToken="true">
    ...
    <div class="box">
          ...
          <fieldset>
            <div class="form-columns">
                ...
                <g:applyLayout name="form/select">
                    ...
                    <content tag="label.for">periodUnitId</content>
        ...
        <div class="btn-box buttons">
            <ul>
                <li><a class="submit save button-primary" onclick="$('#save-period-form').submit();"><span><g:message code="button.save"/></span></a></li>
