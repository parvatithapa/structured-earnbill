...
<div id="swap-plan-dialog" class="bg-lightbox column" title="<g:message code="popup.swap.plan.title"/>"
    ...
    <div class="form-columns single">
        <g:formRemote name="swap-plan-form" id="swap-plan-form"
            ...
            <g:applyLayout name="form/select">
                ...
                <content tag="label.for">swapMethod</content>
                <content tag="include.script">true</content>
                <content tag="onClose">false</content>
    ...
    <div class="form-columns single">
        <g:formRemote name="planSwap-filter-form" url="[action: 'edit']" update="planSwap-placeholder" method="GET">
            <g:hiddenField name="existedPlanItemIdForFilter" id="existedPlanItemIdForFilter" value="${null}"/>
...
<script type="text/javascript">
    ...
    function swapPlan(existedPlanItemId) {
        $('#existedPlanItemIdForFilter').val(existedPlanItemId);
    ...
    function isSwapDateValid() {
        ...
        var nowStr = '${formatDate(date: TimezoneHelper.currentDateForTimezone(session['company_timezone']), formatName: 'datepicker.format')}';
