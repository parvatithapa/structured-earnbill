...
<div class="pager-box">
    ...
    <g:set var="updateColumn" value="mfGroup"/>

    <div class="row">
        <div class="results">
            <g:render template="pagerShowResults" id="${entityType}" params="[template:'list']" model="[steps: [10, 20, 50], update: updateColumn, id:entityType,template:'list', extraParams:[listColumn:updateColumn]]" />
        </div>
     </div>
