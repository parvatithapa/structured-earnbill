...
<div class="form-edit">
    ...
    <div class="form-hold">
        <g:form name="metaFieldGroup-edit-form" action="save" useToken="true">
            <fieldset>
                ...
                <div class="buttons">
                    <ul>
                        <li>
                            <a onclick="updateDLValues('vis-cols-multi-sel');$('#metaFieldGroup-edit-form').submit()" class="submit save button-primary">
