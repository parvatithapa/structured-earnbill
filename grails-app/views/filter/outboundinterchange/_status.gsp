  ...
  <%@ page import="com.sapienter.jbilling.server.integration.db.OutBoundInterchangeDAS" %>
<%--
  OutboundInterChange method filter.
        ...
        <fieldset>
            <div class="input-row">
                <div class="select-bg">
                    ...
                    <g:set var="filter_from" value="${new OutBoundInterchangeDAS().findAll()}"/>
