...
<%@ page import="com.sapienter.jbilling.server.item.TariffPlan" %>
        ...
        <fieldset>
            <div class="input-row">
                <div class="select-bg">
                    ...
                    <g:set var="filter_from" value="${TariffPlan.values()}"/>
                    <g:set var="filter_keys" value="${TariffPlan.values()*.name()}"/>
                    ...
                    <g:applyLayout name="select_small" template="/layouts/includes/select_small" model="[
                            ...
                            select_keys: filter_keys,
                            select_noSelection: filter_noSelection
                    ]">
                    </g:applyLayout>

                </div>
                <label for="filters.${filter.name}.stringValue"><g:message code="filters.tariff.type.label"/></label>
            </div>
        </fieldset>
    </div>
