...
<%@ page import="com.sapienter.jbilling.server.util.Constants; com.sapienter.jbilling.server.order.db.OrderChangeStatusDAS" %>
        ...
        <fieldset>
            <div class="input-row">
                <div class="select-bg">
                    ...
                    <g:set var="filter_from" value="${statuses}"/>
