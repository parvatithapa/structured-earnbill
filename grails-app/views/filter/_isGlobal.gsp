...
<div id="${filter.name}">
    <span class="title"><g:message code="filters.i.global.title"/></span>
    ...
    <div class="slide">
        <fieldset>
            <div class="input-row">
                <div class="select-bg">
                    <g:set var="filter_name" value="filters.${filter.name}.booleanValue"/>
                    <g:set var="filter_value" value="${filter.booleanValue}"/>
                    <g:set var="filter_from" value="${[true, false]}"/>
...
%{--                    <g:select name="filters.${filter.name}.booleanValue"
    ...
    <g:set var="filter_selector" value="select[name='filters.${filter.name}.booleanValue']"/>
