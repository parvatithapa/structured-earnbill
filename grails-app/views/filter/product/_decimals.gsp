...
<div id="${filter.name}">
    <span class="title"><g:message code="filters.hasDecimals.title"/></span>
        ...
        <fieldset>
            <div class="input-row">
                <div class="select-bg">
                    ...
                    <g:set var="filter_valueMessagePrefix" value="filters.hasDecimals"/>
                    <g:set var="filter_noSelection" value="['': message(code: 'filters.hasDecimals.empty')]"/>
