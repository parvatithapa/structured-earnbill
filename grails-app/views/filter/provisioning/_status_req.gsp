<%@ page import="com.sapienter.jbilling.server.provisioning.ProvisioningRequestStatus" %>
        ...
        <fieldset>
            <div class="input-row">
                <div class="select-bg">
                    ...
                    <g:set var="filter_from" value="${ProvisioningRequestStatus.values() }"/>
                ...
                <label for="filters.${filter.name}.stringValue"><g:message code="filters.provisioning.req_status.title"/></label>
            </div>
        </fieldset>
    </div>
