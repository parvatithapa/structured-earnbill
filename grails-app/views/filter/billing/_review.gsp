...
--%>
<div id="${filter.name}">
    <span class="title"><g:message code="filters.billing.review.title"/></span>
        ...
        <fieldset>
            <div class="input-row">
                <div class="select-bg">
                    ...
                    <g:set var="filter_valueMessagePrefix" value="filters.billing.review"/>
                    <g:set var="filter_noSelection" value="['': message(code: 'filters.billing.review.empty')]"/>
