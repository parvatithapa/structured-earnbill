...
<%--
  Shows list of metafield groups available as a templates for creation of an company information type
        ...
        <div class="table-scroll">
            <table id="metafieldGroups" cellspacing="0" cellpadding="0">
                ...
                <g:each var="mfGroup" in="${metaFieldGroups}">
                    <tr>
                        <td>
                            <g:remoteLink class="cell double" action="editCIT" id="${mfGroup.id}" params="[_eventId: 'importMetaFieldGroup']" update="column2" method="GET">
