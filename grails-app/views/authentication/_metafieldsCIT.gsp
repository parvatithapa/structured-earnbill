...
<%--
  ...
  for creation of an company information type fields
        ...
        <div class="table-scroll">
            <table id="metafields" cellspacing="0" cellpadding="0">
                ...
                <g:each var="metaField" in="${metaFields}">
                    <tr>
                        <td>
                            <g:remoteLink class="cell double" action="editCIT" id="${metaField.id}" params="[_eventId: 'addMetaField']" update="column2" method="GET"
                        ...
                        <td class="medium">
                            <g:remoteLink class="cell double" action="editCIT" id="${metaField.id}"
