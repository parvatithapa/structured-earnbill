...
<div class="pager-box">
    ...
    <jB:isPaginationAvailable total="${total ?: 0}">
        <div class="row-center">
            <jB:remotePaginate controller="enumerations" action="list" params="${sortableParams(params: [partial: true, total: total])}" total="${total ?: 0}" update="column1"/>
        </div>
