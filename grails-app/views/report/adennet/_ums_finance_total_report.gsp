%{--
  ...
  --}%
<%@ page import="org.joda.time.DateTime; com.sapienter.jbilling.server.user.db.UserDTO;" %>
<%@ page import="com.sapienter.jbilling.server.user.UserBL;com.sapienter.jbilling.server.user.db.CompanyDTO; org.hibernate.criterion.CriteriaSpecification; com.sapienter.jbilling.server.util.EnumerationBL; com.sapienter.jbilling.server.util.db.EnumerationDTO; com.sapienter.jbilling.server.util.db.EnumerationValueDTO; com.sapienter.jbilling.server.adennet.AdennetHelperService; java.util.Arrays; java.util.ArrayList;" %>
<%@ page import="com.sapienter.jbilling.server.item.db.PlanDTO;" %>
<%--
   finance-total-report
  @author Nitin Yewale
  @since  07-Nov-2022
--%>

<style>
   #finance-report select, #finance-report .select-holder{
        width:221px;
        padding-left: 2px;
   }
</style>
...
%>
<div class="form-columns" id="finance-report">
    ...
    <g:applyLayout name="form/date">
     ...
     <g:applyLayout name="form/select_multiple">
         <content tag="label"><g:message code="bank.active.user"/></content>
         <content tag="label.for">bank_active_user</content>
         <content tag="include.script">true</content>
         <g:select
            multiple="true"
            from="${userNames}"
