...
<div class="form-columns" >
                    <g:applyLayout name="form/checkbox">
                       <g:checkBox class="cb checkbox" name="is_parent_inculde" value="true"/>
                        <label id="custom-label" class = "labelWrap"><g:message code="is.parent.inculde"/></label>
                    ...
                    <g:applyLayout name="form/checkbox">
                    	 <g:checkBox class="cb checkbox" name="include_negative_invoices_reports" value="true"/>
                          <label id="custom-label" class = "labelWrap"><g:message code="negative.invoices"/></label>
                    ...
                    <g:applyLayout name="form/checkbox">
                        ...
                        <label id="custom-label" class = "labelWrap">
                    ...
                    <g:applyLayout name="form/checkbox">
                    	<g:checkBox class="cb checkbox" name="include_mediated_orders_with_active_since_date_in_future" value="true" />
                         <label id="custom-label" class = "labelWrap"><g:message code="mediated.orders.with.active.since.date.in.future"/></label>
					...
					<g:applyLayout name="form/checkbox">
                     ...
                     <g:applyLayout name="form/checkbox">
						<g:checkBox class="cb checkbox" name="include_payments_with_pre_auth" value="true"/>
                          <label id="custom-label" class = "labelWrap"><g:message code="include.payments.with.pre.auth"/></label>
 					...
 					<g:applyLayout name="form/checkbox">
						<g:checkBox class="cb checkbox" name="mediated_orders_with_negative_amounts" value="true"/>
                          <label id="custom-label" class = "labelWrap"><g:message code="mediated.orders.with.negative.amounts"/></label>
                     ...
                     <g:applyLayout name="form/checkbox">
                    	 <g:checkBox class="cb checkbox" name="include_mediated_orders_without_usage_pool" />
                          <label id="custom-label" class = "labelWrap"><g:message code="include.mediated.orders.without.usage.pool"/></label>
                    ...
                    <g:applyLayout name="form/checkbox">
                        ...
                        <label id="custom-label" tag="label">
