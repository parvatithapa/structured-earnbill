...
<%@ page import="com.sapienter.jbilling.server.item.db.PlanDAS; com.sapienter.jbilling.server.util.EnumerationBL; com.sapienter.jbilling.server.util.db.EnumerationValueDTO; com.sapienter.jbilling.server.item.ItemTypeBL; com.sapienter.jbilling.server.item.ItemTypeWS; com.sapienter.jbilling.server.item.ItemBL; com.sapienter.jbilling.server.item.db.ItemDTO; com.sapienter.jbilling.server.user.db.CompanyDTO; com.sapienter.jbilling.server.user.db.CompanyDAS; java.time.LocalDateTime" %>
...
<div class="form-columns">
    ...
    <g:applyLayout name="form/select">
        ...
        <g:select id="item" name="item_id" from="${items}" optionKey="id" optionValue="${{it.description +'(' + it.id+')'}}" noSelection="${['':'All']}" noSelection="${['':'All']}" />
    </g:applyLayout>
    ...
    <g:applyLayout name="form/select">
        ...
        <content tag="include.script">true</content>
        <g:select id="planSelect" name="plan_id" from="${new PlanDAS().findAllActive(session['company_id']).collect {[id: it.id, description: it.item.description]}}" optionKey="id" optionValue="${{it.description +'(' + it.id+')'}}" noSelection="${['':'All']}" noSelection="${['':'All']}" />
    </g:applyLayout>
