...
<%@ page import="com.sapienter.jbilling.server.payment.db.PaymentMethodTypeDAS" %>

<%--
  Parameters for the refund payments report.
...
<div class="form-columns">
    ...
    <g:applyLayout name="form/select">
        <content tag="label"><g:message code="report.refund.payment.method"/></content>
        <content tag="label.for">payment_method_id</content>
        <content tag="include.script">true</content>
        <g:select name="payment_method_id"
                  from="${new PaymentMethodTypeDAS().findAllByEntity(session['company_id'])}"
                  noSelection="${['-1':'All']}"
                  optionKey="id"
