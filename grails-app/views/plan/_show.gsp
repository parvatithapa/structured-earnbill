        ...
        <div class="sub-box">
            <table class="dataTable" cellspacing="0" cellpadding="0">
                ...
                <g:if test="${plan.item.defaultPrices}">
                    <g:set var="price"
                           value="${plan.item.getPrice(TimezoneHelper.currentDateForTimezone(session['company_timezone']), session['company_id'] as Integer)}"/>
                    <tr>
                ...
                <g:if test="${plan != null && plan.freeTrial}">
                    <tr>
                        <td><g:message code="filters.plan.free.trial.period"/>:</td>
                        <td class="value">
                            <g:if test="${plan.freeTrialPeriodUnit != null}">
                                ${plan?.freeTrialPeriodValue} <g:message code="${plan?.freeTrialPeriodUnit.getMessageKey()}"/>
                            </g:if>
                        </td>
                    </tr>
                </g:if>
...
<!-- plan prices -->
                ...
                <g:each var="planItem" status="index" in="${plan.planItems.sort { it.precedence }}">
                    ...
                    <tr>
                        ...
                        <td class="value" colspan="3">
                            <sec:access url="/product/show">
                                <g:remoteLink controller="product" action="show" id="${planItem.item.id}"
                    ...
                    <g:if test="${planItem.bundle && planItem.bundle.quantity?.compareTo(BigDecimal.ZERO) > 0}">
                        <tr>
                            ...
                            <td class="value"><g:message
                                    code="plan.bundle.add.if.exists.${planItem.bundle.addIfExists}"/></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="value"><g:message
                                    code="bundle.target.customer.${planItem.bundle.targetCustomer}"/></td>
                        </tr>
                    ...
                    <g:render template="/plan/priceModel"
                              model="[model: planItem.getPrice(TimezoneHelper.currentDateForTimezone(session['company_timezone']))]"/>
            ...
            <div class="sub-box"><table class="dataTable" cellspacing="0" cellpadding="0" width="100%">
                ...
                <g:each var="usagePools" in="${plan.usagePools}">
                    <tr>
                        ...
                        <td style="color:#858585;"><g:formatNumber number="${usagePools.getQuantity()}"
                                                                   formatName="money.format"/></td>
    ...
    <div class="btn-box">
        <sec:ifAllGranted roles="PLAN_61">
            <g:link controller="planBuilder" action="edit" id="${plan.id}" class="submit edit"><span><g:message
                    code="button.edit"/></span></g:link>
        </sec:ifAllGranted>

        <sec:ifAllGranted roles="PLAN_62">
            <g:if test="${canBeDeleted}">
                <a onclick="showConfirm('delete-${plan.id}');" class="submit delete"><span><g:message
