...
<div class="column-hold">
    ...
    <g:form name="save-notification-form" url="[action: 'saveNotificationMessage']" useToken="true">
        ...
        <div class="box">
            <div class="sub-box">
              <fieldset>
                <div class="form-columns">
                    ...
                    <g:render template="/notifications/descriptions" model="[notificationMessageType: notificationMessageType]"/>
                </div>
            </fieldset>
          </div>
            ...
            <div class="buttons">
                <ul>
                    <li><a onclick="$('#save-notification-form').submit();" class="submit save button-primary"><span><g:message code="button.save"/></span></a></li>
