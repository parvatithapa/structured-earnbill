...
<div class="btn-box">
        <g:link controller="notifications" action="editCategory" class="submit add button-primary" params="${[add: true]}"><span><g:message code="button.create.notification.category"/></span></g:link>
