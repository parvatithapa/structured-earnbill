...
<div class="form-edit">
    ...
    <div class="form-hold">
        <g:form name="save-category-form" url="[action: 'saveCategory']" useToken="true">
            <fieldset>
                ...
                <div class="buttons">
                    <ul>
                        <li><a onclick="$('#save-category-form').submit();" class="submit save button-primary"><span><g:message
