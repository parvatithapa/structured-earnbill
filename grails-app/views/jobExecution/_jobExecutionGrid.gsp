...
$(document).ready(function () {
    $(jqTableGrid).jqGrid({
        url:'<g:createLink action="findJobExecutionsAsJson"/>',
        datatype: "json",
        colNames:[
            '<g:message code="jobExecution.label.id"/>',
            '<g:message code="jobExecution.label.startDate"/>',
            '<g:message code="jobExecution.label.endDate"/>',
            '<g:message code="jobExecution.label.jobType"/>',
            '<g:message code="jobExecution.label.status"/>'
        ],
        colModel:[
            { name: 'id', editable: false, search:true, sortable:true, width: 60},
            { name: 'startDate', editable: false, search:true, sortable:true, width: 150, formatter: 'date' , formatOption:{newFormat:'<g:message code="date.pretty.format"/>'}},
            { name: 'endDate', editable: false, search:true, sortable:true, width: 150, formatter: 'date' , formatOption:{newFormat:'<g:message code="date.pretty.format"/>'}},
            { name: 'jobType', editable: false, search:true, sortable:true, width: 150},
            { name: 'status', editable: false, search:true, sortable:true, width: 150}
        ],
        sortname: 'id',
        sortorder: 'desc',
        autowidth: true,
