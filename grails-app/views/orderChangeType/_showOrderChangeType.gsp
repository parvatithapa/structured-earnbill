<%@ page import="com.sapienter.jbilling.common.Constants; com.sapienter.jbilling.server.item.db.ItemTypeDTO" %>
%{--
...
<div class="column-hold">
    ...
    <g:if test="${selected.id != Constants.ORDER_CHANGE_TYPE_DEFAULT}">
        <div class="btn-box">
            <div class="row">
