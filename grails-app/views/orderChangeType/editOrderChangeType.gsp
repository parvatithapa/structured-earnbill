...
<div class="form-edit">
    ...
    <div class="form-hold">
        <g:form id="save-orderChangeType-form" name="order-change-period-form" url="[action: 'save']" useToken="true">
        ...
        <div class="buttons">
            <ul>
                <li><a class="submit save button-primary" onclick="$('#save-orderChangeType-form').submit();"><span><g:message
