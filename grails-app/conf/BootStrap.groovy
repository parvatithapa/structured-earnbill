...
class BootStrap {
	...
	def init = { servletContext ->
		...
		//increased conversation lock time out
		conversationManager.lockTimeoutSeconds = 60
		...
		// create invoice number preference if not preset for entity.
		PreferenceBL.createIfNotPresentForAllEntities(Constants.PREFERENCE_INVOICE_NUMBER, "1")
