...
grails.project.dependency.resolution = {
    ...
    dependencies {
        ...
        build ('com.lowagie:itext:4.2.1') {
            transitive = false
        }
        build 'org.eclipse.jdt:ecj:3.35.0'  // for tomcat8 plugin and jasper report
        ...
        compile 'com.github.tomakehurst:wiremock-jre8-standalone:2.35.2'
        ...
        compile('org.apache.velocity:velocity-tools:2.0') {
            excludes 'struts-core', 'struts-taglib', 'struts-tiles', 'commons-logging', 'dom4j'
        }
        compile 'org.dom4j:dom4j:2.1.3'

        compile('net.sf.jasperreports:jasperreports:6.20.6') {
            excludes 'jaxen', 'xalan', 'xml-apis', 'jdtcore', 'itext', 'commons-logging', 'stax-api'
        }

        compile ('org.codehaus.castor:castor-xml:1.4.1')
        compile ('org.mozilla:rhino:1.7.15')
        compile ('com.ibm.icu:icu4j:73.2')

        compile "org.bouncycastle:bcprov-jdk16:1.46"

        compile 'net.sf.jasperreports:jasperreports-fonts:6.20.6'
        ...
        compile 'com.mchange:c3p0:0.10.1'
        compile 'com.mchange:mchange-commons-java:0.3.1'
        ...
        def springBatchVersion = "3.0.10.RELEASE"
        ...
        compile('org.springframework.data:spring-data-jpa:1.11.23.RELEASE') {
        ...
        compile ('org.apache.santuario:xmlsec:2.1.7'){
            excludes 'woodstox-core'
        }
        compile 'com.fasterxml.woodstox:woodstox-core:6.4.0'
        compile ('org.owasp.esapi:esapi:2.3.0.0'){
            excludes 'log4j', 'neko-htmlunit', 'commons-fileupload'
        }
        compile 'net.sourceforge.htmlunit:neko-htmlunit:2.61.0'
        ...
        compile ('org.springframework.boot:spring-boot-starter-hateoas:1.5.9.RELEASE') {
            excludes 'log4j-over-slf4j', 'logback-classic', 'spring-boot-starter-tomcat', 'snakeyaml'
        }
        compile 'org.yaml:snakeyaml:2.0'
        compile 'com.googlecode.libphonenumber:libphonenumber:8.13.37'

        compile 'com.googlecode.libphonenumber:geocoder:2.231'
        ...
        compile 'com.googlecode.libphonenumber:carrier:1.221'
        ...
        compile 'org.apache.tika:tika-core:2.4.1'
        ...
        runtime 'org.eclipse.jdt:ecj:3.35.0'  // for tomcat8 plugin and jasper reports
        ...
        runtime 'com.mysql:mysql-connector-j:9.0.0'
        runtime group: 'org.hsqldb', name: 'hsqldb', version: '2.7.3', classifier: 'jdk8'
        ...
        def cxfVersion="3.1.10"
        runtime("org.apache.cxf:cxf-rt-ws-security:${cxfVersion}") {
            excludes 'bcprov-jdk15on', 'opensaml-saml-impl', 'opensaml-xacml-impl', 'opensaml-xacml-saml-impl'
        }
        ...
        provided("org.apache.cxf:cxf-rt-frontend-jaxrs:${cxfVersion}") {
            excludes "javax.ws.rs-api"
        }
        ...
        test    ('com.lowagie:itext:4.2.1') {
            transitive = false
        }

        test 'com.github.tomakehurst:wiremock-jre8-standalone:2.35.2'
        ...
        compile ('io.github.resilience4j:resilience4j-retry:1.7.0')
    ...
    plugins {
        ...
        compile (":cxf:2.1.1") {
            ...
            excludes "cxf-rt-transports-http"
        }
        ...
        runtime(":hibernate4:4.3.5.5") {
            excludes "hibernate-validator", "ehcache-core", 'dom4j'
        }
