...
class MigrationService implements IMigrationServicesSessionBean {
    ...
    */
    ...
    /**
     * Save a migration rated cdr for limitless mobile
     * @param entityId
     * @param metaFieldName
     * @param metaFieldValue
     * @return UserWS
    ...
    @WebResult
    @WebMethod
    void saveMigrationCdr(JbillingMediationRecord mediationRecordLineWS) {
        migrationServicesSession.saveMigrationCdr(mediationRecordLineWS);
    }

    @WebResult
    @WebMethod
    @Override
    UUID createMediationProcessForMigration(Integer mediationConfigId) {
        return migrationServicesSession.createMediationProcessForMigration(mediationConfigId);
    }
