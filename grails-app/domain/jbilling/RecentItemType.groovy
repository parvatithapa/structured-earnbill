...
enum RecentItemType {
    ...
    CREDITNOTE          ("creditNote", "list", null, "icon11.gif","recent.item.creditNote.title"),
    OUTBOUNDINTERCHANGE  ("outboundInterChange", "list", null, "icon26.gif","recent.item.outboundInterChange.title");
