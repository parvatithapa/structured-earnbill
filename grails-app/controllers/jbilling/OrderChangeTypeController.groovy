...
class OrderChangeTypeController {
    ...
    def getList(params) {
        ...
        securityValidator.validateCompany(orderChangeType?.entity?.id, Validator.Type.VIEW)
    ...
    def show (){
        ...
        securityValidator.validateCompany(orderChangeType?.entityId, Validator.Type.VIEW)
    ...
    def edit (){
        ...
        securityValidator.validateCompany(orderChangeType?.entityId, Validator.Type.EDIT)
    ...
    def save (){
        ...
        if(ws.id) {
            securityValidator.validateCompany(webServicesSession.getOrderChangeTypeById(ws.id).entityId, Validator.Type.EDIT)
        }
        ...
        if (params.id) {
            ...
            if (orderChangeType) {
                ...
                try {
                    ...
                    viewUtils.resolveException(flash, session.locale, e);
                    render view: 'editOrderChangeType', model: [orderChangeType: orderChangeType,
                                                                itemTypes: productService.getItemTypes(session['company_id'], null)]
                } catch (Exception e) {
                    log.error e.getMessage()
