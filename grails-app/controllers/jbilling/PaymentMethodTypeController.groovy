...
class PaymentMethodTypeController {
	...
	def list (){
        ...
        securityValidator.validateCompany(paymentMethod?.entity?.id, Validator.Type.VIEW)
	...
	def delete (){
		if(params.id) {
            ...
            securityValidator.validateCompany(paymentMethodType?.entity?.id, Validator.Type.EDIT)
	...
	def editPMFlow ={
		initialize {
			action {
				...
				if(paymentMethodId) {
                    ...
                    securityValidator.validateCompany(paymentMethod?.owningEntityId, Validator.Type.EDIT)
				} else {
		...
		updatePM {
			action {
                PaymentMethodTypeWS paymentMethod = conversation.paymentMethod
