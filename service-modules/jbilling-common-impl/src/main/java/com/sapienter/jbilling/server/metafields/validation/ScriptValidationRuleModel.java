...
public class ScriptValidationRuleModel extends AbstractValidationRuleModel {
    ...
    private static final FormatLogger LOG = new FormatLogger(Logger.getLogger(ScriptValidationRuleModel.class));
    ...
    public ScriptValidationRuleModel() {
        ...
        setAttributeDefinitions(
                new MetaFieldAttributeDefinition(VALIDATION_SCRIPT_FIELD, MetaFieldAttributeDefinition.Type.STRING, true)
        );
    }
