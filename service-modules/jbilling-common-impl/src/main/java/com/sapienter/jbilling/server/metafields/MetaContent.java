...
public interface MetaContent {
    ...
    default MetaFieldValue getMetaField(String name, Integer groupId, Integer companyId){
        return MetaFieldHelper.getMetaField(this, name, groupId, companyId);
    }

    default MetaFieldValue getMetaFieldByEntityType(String name, EntityType entityType, Integer companyId) {
        return MetaFieldHelper.getMetaField(this, name, entityType, companyId);
    }
}