...
public class MetaFieldGroupBL {
    ...
    private static final FormatLogger LOG = new FormatLogger(Logger.getLogger(MetaFieldGroupBL.class));
	...
	public Integer save() {
		...
		try {
			MetaFieldGroup groupWithSameName = mfGroupDas.getGroupByName(group.getEntityId(), group.getEntityType(), group.getDescription());
			...
			//group.setDescription(group.getDescription(), Constants.LANGUAGE_ENGLISH_ID);
    ...
    public static final  MetaFieldGroupWS getWS(MetaFieldGroup groupDTO){
    	...
    	if(groupDTO!=null){
            ...
            ws.setEntityId(groupDTO.getEntityId());
    		...
    		if(groupDTO.getDescription(Constants.LANGUAGE_ENGLISH_ID)!=null){
	    		List<InternationalDescriptionWS> tmpDescriptions=new ArrayList<InternationalDescriptionWS>(1);
	    		tmpDescriptions.add(DescriptionBL.getInternationalDescriptionWS(groupDTO.getDescriptionDTO(Constants.LANGUAGE_ENGLISH_ID)));
