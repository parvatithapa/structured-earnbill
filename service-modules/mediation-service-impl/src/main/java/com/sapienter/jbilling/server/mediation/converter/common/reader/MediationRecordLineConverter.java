 ...
 * @since 12/18/12
 */
public interface MediationRecordLineConverter {

    ICallDataRecord convertLineToRecord(String line);
    ICallDataRecord convertLineToRecord(String line, Format format) ;
}
