...
public class MediationStepContext {
    ...
    private ICallDataRecord record;
    private Integer entityId;

    private MediationStepContext() {}

    public MediationStepContext(MediationStepResult result, ICallDataRecord record, Integer entityId) {
        this.result = result;
        this.record = record;
    ...
    public void setRecord(ICallDataRecord record) {
        this.record = record;
    }
