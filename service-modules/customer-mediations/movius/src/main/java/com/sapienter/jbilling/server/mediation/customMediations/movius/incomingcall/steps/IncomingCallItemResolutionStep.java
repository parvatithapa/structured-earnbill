...
public class IncomingCallItemResolutionStep extends AbstractMediationStep<MediationStepResult> {

    private static final String DESTINATION_NUMBER_FIELD_NAME = "called Number";
    
    private static final Logger LOG = LoggerFactory.getLogger(IncomingCallItemResolutionStep.class);
