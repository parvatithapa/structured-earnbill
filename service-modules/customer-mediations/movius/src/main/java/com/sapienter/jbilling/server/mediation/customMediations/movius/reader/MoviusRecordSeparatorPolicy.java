...
public class MoviusRecordSeparatorPolicy extends DefaultRecordSeparatorPolicy {
    
    private String headerIdentifierName = "cdr-type";
    ...
    public boolean isEndOfRecord(final String line) {
        if (isLineEmpty(line) || line.contains(getHeaderIdentifierName())) {
            return false;
        }
