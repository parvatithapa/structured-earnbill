 ...
 *
 */
public class CallRelayMediationJob extends DefaultMediationJob {
	
    protected CallRelayMediationJob(String job, String lineConverter, String resolver, String writer, String recycleJob) {
    	super(job, lineConverter, resolver,writer, recycleJob);
    }
	
    public static MediationJob getMediationJobInstance() {
        return new CallRelayMediationJob(FullCreativeConstants.CALL_RELAY_MEDIATION_CONFIGURATION, 
        								 ...
        								 FullCreativeConstants.CALL_RELAY_RECYCLE_CONFIGURATION);
    } 
    
    public static MediationJob getRecycleJobInstance() {
        return new CallRelayMediationJob(FullCreativeConstants.CALL_RELAY_RECYCLE_CONFIGURATION, 
        								 FullCreativeConstants.INBOUND_CALL_MEDIATION_CONVERTER_BEAN,
        								 FullCreativeConstants.INBOUND_CALL_MEDIATION_CDR_RESOLVER_BEAN, 
        								 FullCreativeConstants.JMR_DEFAULT_WRITER_BEAN, 
        								 null);
