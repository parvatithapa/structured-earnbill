...
@ApiModel(value = "Main Subscription Model", description = "Main Subscription Model")
public class MainSubscriptionWS implements Serializable {
    ...
    @ApiModelProperty(value = "One of the defined order period ids for the specific company", required = true)
    ...
    @ApiModelProperty(value = "Invoicing day within the period defined by periodId", required = true)
    ...
    @ApiModelProperty(value = "Invoicing day within the period defined by year period", required = true)
    ...
    @ApiModelProperty(value = "The name of the template used.")
