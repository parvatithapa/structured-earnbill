...
@Test(groups = { "selenium-ui-functional", "sanity" }, testName = "JBillingSanityTest")
public class JBillingSanityTest extends TestCase {

	private static final Logger logger = LoggerFactory.getLogger(JBillingSanityTest.class);
  ...
  public void testJbillingSanityTest() throws Exception {
	    ...
	    //Review Payment
	    driver.findElement(By.id("submitToPaymentGateway")).click();
	    driver.findElement(By.cssSelector("a.submit.payment > span")).click();
...
//	    driver.findElement(By.linkText("editProduct")).click();
  ...
  private boolean isAlertPresent() {
	  logger.debug("In isAlertPresent Method");
    try {
  ...
  private String closeAlertAndGetItsText() {
	  logger.debug("IN closeAlertAndGetItsText Method");
    try {
