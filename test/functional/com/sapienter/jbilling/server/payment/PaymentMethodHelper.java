...
public final class PaymentMethodHelper {
	...
	public static PaymentInformationWS createCreditCard(Integer methodId, String cardHolderName, String cardNumber, Date date) {
		...
		addMetaField(metaFields, CC_MF_EXPIRY_DATE, false, true, DataType.CHAR, 3,
				(DateTimeFormat.forPattern(Constants.CC_DATE_FORMAT).print(date.getTime()).toCharArray()));
		// have to pass meta field card type for it to be set
		addMetaField(metaFields, CC_MF_TYPE, true, false, DataType.STRING, 4, CreditCardType.VISA);
