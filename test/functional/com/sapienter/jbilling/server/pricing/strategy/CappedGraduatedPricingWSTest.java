 ...
 * @since 10-Jul-2012
 */
@Test(groups = { "web-services", "pricing", "graduated-capped" }, testName = "CappedGraduatedPricingWSTest")
public class CappedGraduatedPricingWSTest {
    ...
    public void testCappedGraduatedPricing() {
        ...
        PriceModelWS graduatedPrice = new PriceModelWS(PriceModelStrategy.CAPPED_GRADUATED.name(), new BigDecimal("1.00"), CURRENCY_ID);
	    ...
	    String itemName = "TEST-CAP-GRAD-" + random;
        ItemDTOEx item = PricingTestHelper.buildItem(itemName, "Cap graduated pricing test", categoryId);
	    ...
	    String userName = "cap-grad-pricing-" + random;
