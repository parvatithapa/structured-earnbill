...
@Configuration
public class SapphireTestConfig {

    @Autowired
    private Environment environment;

    @Bean(name = "sapphireDataSource")
    ...
    @Bean(name = "sapphireJdbcTemplate")
    public JdbcTemplate jdbcTemplate(@Qualifier("sapphireDataSource") DataSource dataSource) {
