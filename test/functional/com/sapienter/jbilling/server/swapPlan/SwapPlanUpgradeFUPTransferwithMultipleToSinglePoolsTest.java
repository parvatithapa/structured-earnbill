...
public class SwapPlanUpgradeFUPTransferwithMultipleToSinglePoolsTest{

	private static final Logger logger = LoggerFactory.getLogger(SwapPlanUpgradeFUPTransferwithMultipleToSinglePoolsTest.class);
	...
	/**
	 ...
	 # A plan subscription is Upgrade from (pool 100+ pool 85) mins free to (Pool 225) mins free
	 # No Overage before and after the plan swap.
	 */
	@Test
	public void test001SwapPlanUpgradeFUPTransferwithMultipleToSinglePoolsTestD1 () throws Exception{
		//Customer 'Customer D1' with Next Invoice Date 01-01-2016
		UserWS user  = FullCreativeUtil.createUser("Customer D1 - ");
		userId = user.getId();
	 ...
	 */
	@Test
	public void test002SwapPlanUpgradeFUPTransferwithMultipleToSinglePoolsTestD2 () throws Exception{
		//Customer 'Customer D2' with Next Invoice Date 01-01-2016
		UserWS user  = FullCreativeUtil.createUser("Customer D2 - ");
		userId = user.getId();
		assertNotNull("user should not be null",user);
		user = api.getUserWS(userId);
		...
		assertEquals("One Time Order Overage Charges Should be : ",new BigDecimal("6.41"),
	 ...
	 */
	@Test
	public void test003SwapPlanUpgradeFUPTransferwithMultipleToSinglePoolsTestD3 () throws Exception{
		//Customer 'Customer D3' with Next Invoice Date 01-01-2016
		UserWS user  = FullCreativeUtil.createUser("Customer D3 - ");
		userId = user.getId();
		assertNotNull("user should not be null",user);
		user = api.getUserWS(userId);
		...
		assertEquals("One Time Order Overage Charges Should be : ",new BigDecimal("21.61"),
				oneTimeUsageOrder.getTotalAsDecimal().setScale(Constants.BIGDECIMAL_SCALE_STR, BigDecimal.ROUND_HALF_UP));
