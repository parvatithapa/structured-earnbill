...
@Test(groups = { "swapPlan" }, testName = "SwapPlanDowngradeFUPTransferwithMultiplePoolsTest")
public class SwapPlanDowngradeFUPTransferwithMultiplePoolsTest{

	private static final Logger logger = LoggerFactory.getLogger(SwapPlanDowngradeFUPTransferwithMultiplePoolsTest.class);
	...
	private BigDecimal remainingUsageQuantity = BigDecimal.ZERO;
	UserWS user = null;
	 ...
	 */
	@Test
	public void test001SwapPlanDowngradeFUPTransferwithMultiplePoolsTestB4 () throws Exception{
		//Customer 'Customer B4' with Next Invoice Date 01-01-2016
		UserWS user  = FullCreativeUtil.createUser("Customer B4 - ");
		userId = user.getId();
	...
	@Test
	public void test002SwapPlanDowngradeFUPTransferwithMultiplePoolsTestB5 () throws Exception{
		//Customer 'Customer B5' with Next Invoice Date 01-01-2016
		...
		assertEquals("After Swap Plan One Time Order Overage Charges Should be : ",new BigDecimal("44.01"), 
				oneTimeUsageOrder.getTotalAsDecimal().setScale(2, BigDecimal.ROUND_HALF_UP));
	...
	@Test
	public void test003SwapPlanDowngradeFUPTransferwithMultiplePoolsTestB6 () throws Exception{
		//Customer 'Customer B6' with Next Invoice Date 01-01-2016
		UserWS user  = FullCreativeUtil.createUser("Customer B6 - ");
		userId = user.getId();
		assertNotNull("user should not be null",user);
		user = api.getUserWS(userId);
		...
		assertEquals("After Swap Plan One Time Order Overage Charges Should be : ",new BigDecimal("12.66"), 
				oneTimeUsageOrder.getTotalAsDecimal().setScale(2, BigDecimal.ROUND_HALF_UP));
