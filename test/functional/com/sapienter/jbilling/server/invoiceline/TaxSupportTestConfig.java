...
@Configuration
public class TaxSupportTestConfig {

    @Autowired
    private Environment environment;

    @Bean(name = "taxSupportDataSource")
    ...
    @Bean(name = "taxSupportJdbcTemplate")
    public JdbcTemplate jdbcTemplate(@Qualifier("taxSupportDataSource") DataSource dataSource) {
