...
@Test(groups = { "test-distributel", "distributel" }, testName = "EmergencyAddressUpdateNorthern911TestCases")
public class EmergencyAddressUpdateNorthern911TestCases {
    private static final Logger logger = LoggerFactory.getLogger(EmergencyAddressUpdateNorthern911TestCases.class);
    ...
    private static final String EMERGENCY_ADDRESS_UPDATE_NORTHERN_911_TASK = "com.sapienter.jbilling.server.user.tasks.EmergencyAddressUpdateNorthern911FakeTask";
...
//        Thread.sleep(10000);
        ...
        for (MetaFieldValueWS metaFieldValueWS : metaFields) {
            if (EMERGENCY_ADDRESS_UPDATED_MF.equals(metaFieldValueWS.getFieldName())) {
                ...
                assertEquals("Emergency Address is not updated  ", true, metaFieldValueWS.getValue());
