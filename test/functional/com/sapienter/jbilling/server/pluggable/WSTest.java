...
@Test(groups = {"web-services", "pluggable"}, testName = "pluggable.WSTest")
public class WSTest extends ApiTestCase {
	
	@Test
	public void testGetPluginTypeWSById() throws Exception{
		
		String className = "com.sapienter.jbilling.server.pluggableTask.OrderChangeBasedCompositionTask";
