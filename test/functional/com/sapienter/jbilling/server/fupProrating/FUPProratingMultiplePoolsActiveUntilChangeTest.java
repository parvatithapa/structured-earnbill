 ...
 *
 */
@Test(groups = { "fupProrating" }, testName = "FUPProratingMultiplePoolsActiveUntilChangeTest")
public class FUPProratingMultiplePoolsActiveUntilChangeTest {

	private static final Logger logger = LoggerFactory.getLogger(FUPProratingMultiplePoolsActiveUntilChangeTest.class);
	...
	public void test004FupProratingActiveUntilDateChangeScenarioB4() {
		...
		try {
			logger.debug("### FUP Proration B4 Scenario - Active Until date change of Monthly order - Plan containing two usage pools - No overage before but  overage after the date change ###");

			//Customer B4 with Next Invoice Date 01-01-2016
