...
public class AccountInformationTypeBuilder {
	...
	public AccountInformationTypeBuilder addMetaFields(MetaFieldWS[] listMetaFields) {
		if(listMetaFields != null) {
			for (MetaFieldWS metaField : listMetaFields) {
				metaFields.add(metaField);
			}
		}
	...
	public AccountInformationTypeBuilder addMetaFields(List<MetaFieldWS> metaFields) {
