...
public class PrepaidCustomerUsagePoolCreationAndEvaluationTest {
    ...
    private static final String USER_01 = "Test-PP-FUP-Eval-User-1" + System.currentTimeMillis();
    private static final String ORDER_01 = "subscriptionOrder_01";
    private static final String USER_02 = "Test-PP-FUP-Eval-User-2" + System.currentTimeMillis();
    private static final String ORDER_02 = "subscriptionOrder_02";
    private static final String USER_03 = "Test-PP-FUP-Eval-User-3" + System.currentTimeMillis();
    private static final String ORDER_03 = "subscriptionOrder_03";
    private static final String USER_04 = "Test-PP-FUP-Eval-User-4" + System.currentTimeMillis();
    ...
    private final String testCat1 = "MediatedUsageCategoryForCUP";
    ...
    private void cleanUp(String user01) {
        ...
        Arrays.stream(api.getUserOrdersPage(testBuilder.getTestEnvironment().idForCode(user01), 10, 0))
                .forEach(order -> api.deleteOrder(order.getId()));
        api.deleteUser(testBuilder.getTestEnvironment().idForCode(user01));
    }
    ...
    private static Integer createOneTimeOrder(Integer userId, Date activeSinceDate, String inboundProductQuantity) throws JbillingAPIException, IOException {
