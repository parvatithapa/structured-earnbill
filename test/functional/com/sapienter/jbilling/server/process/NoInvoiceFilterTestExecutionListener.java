...
@Test(testName = "NoInvoiceFilterTestExecutionListener")
public class NoInvoiceFilterTestExecutionListener extends AbstractTestExecutionListener {

    private static final Logger logger = LoggerFactory.getLogger(NoInvoiceFilterTestExecutionListener.class);
