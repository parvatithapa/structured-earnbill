...
@Test(groups = { "web-services", "notes" }, testName = "CustomerNotesWSTest")
public class CustomerNotesWSTest {

    private static final Logger logger = LoggerFactory.getLogger(CustomerNotesWSTest.class);
    ...
    public void test001CreationAndRetrievalCustomerWithMultipleNotes() throws Exception{
        ...
        try {
            ...
            //Verify Note Data
            Arrays.sort(ret.getCustomerNotes(), (n1, n2) -> n1.getNoteTitle().compareTo(n2.getNoteTitle()));
    ...
    public void test002AddNotesToOldUser() throws Exception{
        ...
        try {
            ...
            logger.debug("User Id Test Case 2 {}", userId);
            //NOTE 3
    ...
    private static UserWS createUserWith2Notes(boolean goodCC, Integer parentId, Integer currencyId) throws JbillingAPIException, IOException {
        return createUserWith2Notes(goodCC, parentId, currencyId, true);
    }

    private static UserWS createUserWith2Notes(boolean goodCC, Integer parentId, Integer currencyId, boolean doCreate) throws JbillingAPIException, IOException {
        JbillingAPI api = JbillingAPIFactory.getAPI();
