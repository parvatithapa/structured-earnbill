...
@Configuration
public class DistributelTestConfig {

    @Autowired
    private Environment environment;

    @Bean(name = "distDataSource")
    ...
    @Bean(name = "distJdbcTemplate")
    public JdbcTemplate jdbcTemplate(@Qualifier("distDataSource") DataSource dataSource) {
    ...
    @Bean
    public JobExplorerFactoryBean jobExplorer(@Qualifier("distDataSource") DataSource dataSource) throws Exception {
