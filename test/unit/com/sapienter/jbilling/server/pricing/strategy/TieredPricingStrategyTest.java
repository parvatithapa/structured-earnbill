...
public class TieredPricingStrategyTest extends BigDecimalTestCase {
    ...
    public void testApplyToNoAttributes() throws Exception {
        ...
        strategy.applyTo(null, result, null, planPrice, new BigDecimal(10), getUsage(new BigDecimal(1000)), false, null);
    ...
    public void testTieredNoUsage() throws Exception {
        ...
        strategy.applyTo(null, result, null, planPrice, new BigDecimal(500), getUsage(BigDecimal.ZERO), false, null);
        ...
        strategy.applyTo(null, result, null, planPrice, new BigDecimal(750), getUsage(BigDecimal.ZERO), false, null);
        ...
        strategy.applyTo(null, result, null, planPrice, new BigDecimal(2000), getUsage(BigDecimal.ZERO), false, null);
    ...
    public void testTieredWithUsage() throws Exception {
        ...
        // 100 * $2 = $200
        // $200 total, or $2/unit
        strategy.applyTo(null, result, null, planPrice, new BigDecimal(100), getUsage(new BigDecimal(1500)), false, null);
        ...
        // 1000 * $2 = $2000
        // $5000 total, or $2.50/unit
        strategy.applyTo(null, result, null, planPrice, new BigDecimal(2000), getUsage(new BigDecimal(500)), false, null);
        assertEquals(new BigDecimal("2.50"), result.getPrice());
        ...
        strategy.applyTo(null, result, null, planPrice, new BigDecimal(2000), getUsage(new BigDecimal(700)), false, null);
        ...
        strategy.applyTo(null, result, null, planPrice, new BigDecimal(500), getUsage(new BigDecimal(5000)), false, null);
