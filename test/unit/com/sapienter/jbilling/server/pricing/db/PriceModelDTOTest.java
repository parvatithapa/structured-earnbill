...
import com.sapienter.jbilling.server.pricing.strategy.ZeroPricingStrategy;
...
public class PriceModelDTOTest extends BigDecimalTestCase {
    ...
    public void testGetStrategy() {
        ...
        planPrice.setType(PriceModelStrategy.ZERO);
        assertTrue(planPrice.getStrategy() instanceof ZeroPricingStrategy);
    }
    ...
    public void testApplyTo() {
        ...
        planPrice.applyTo(null, null, null, result, null, null, false, null);
    ...
    public void testFromWS() {
        ...
        assertEquals(PriceModelStrategy.FLAT, dto.getType());
    ...
    public void testGetPriceForDate() {
        ...
        prices.put(CommonConstants.EPOCH_DATE, new PriceModelDTO(PriceModelStrategy.FLAT, new BigDecimal("0.10"), null));
        prices.put(new DateMidnight(2011, 6, 1).toDate(), new PriceModelDTO(PriceModelStrategy.FLAT, new BigDecimal("0.20"), null));
        prices.put(new DateMidnight(2011, 8, 1).toDate(), new PriceModelDTO(PriceModelStrategy.FLAT, new BigDecimal("0.30"), null));
