...
public class UtilTest extends TestCase {
    ...
    public void testUtilCheckDigitCalc() {
        String cc = "411111111111115";
        int check = Util.calcLuhnCheckDigit(cc);
        assertTrue("Number is invalid", Util.luhnCheck(cc + check));
    }

    public void testGetPaymentMethod() {
        String ccNumber = "340000000000001";
        assertEquals("Incorrect payment type, AMEX expected",
                Constants.PAYMENT_METHOD_AMEX, Util.getPaymentMethod(ccNumber.toCharArray())
        );
        ...
        assertEquals("Incorrect payment type, Diners Club Carte Blanche expected",
                Constants.PAYMENT_METHOD_DINERS, Util.getPaymentMethod(ccNumber.toCharArray())
        );
        ...
        assertEquals("Incorrect payment type, MASTERCARD expected",
                Constants.PAYMENT_METHOD_MASTERCARD, Util.getPaymentMethod(ccNumber.toCharArray())
        );
        ...
        assertEquals("Incorrect payment type, Discover Card expected",
                Constants.PAYMENT_METHOD_DISCOVER, Util.getPaymentMethod(ccNumber.toCharArray())
        );
        ...
        assertEquals("Incorrect payment type, InstaPayment expected",
                Constants.PAYMENT_METHOD_INSTAL_PAYMENT, Util.getPaymentMethod(ccNumber.toCharArray())
        );
        ...
        assertEquals("Incorrect payment type, JCB expected",
                Constants.PAYMENT_METHOD_JCB, Util.getPaymentMethod(ccNumber.toCharArray())
        );
        ...
        assertEquals("Incorrect payment type, MAESTRO (=LASER) expected",
                Constants.PAYMENT_METHOD_MAESTRO, Util.getPaymentMethod(ccNumber.toCharArray())
        );
        ccNumber = "6706000000000111";
        assertEquals("Incorrect payment type, LASER expected",
                Constants.PAYMENT_METHOD_LASER, Util.getPaymentMethod(ccNumber.toCharArray())
        );
        ...
        assertEquals("Incorrect payment type, VISA expected",
                Constants.PAYMENT_METHOD_VISA, Util.getPaymentMethod(ccNumber.toCharArray())
        );

        ccNumber = "4026000000000111";
        assertEquals("Incorrect payment type, VISA ELECTRON expected",
                Constants.PAYMENT_METHOD_VISA_ELECTRON, Util.getPaymentMethod(ccNumber.toCharArray())
        );
        ...
        assertEquals("Incorrect payment type, GatewayKey expected",
                Constants.PAYMENT_METHOD_GATEWAY_KEY, Util.getPaymentMethod(ccNumber.toCharArray())
        );
    }
}
