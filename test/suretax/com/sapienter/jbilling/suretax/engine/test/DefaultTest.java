...
public abstract class DefaultTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		parameters.put(AbstractSureTaxRequestTask.SURETAX_REQUEST_URL,
				SURETAX_TESTAPI_POST_URL);
		parameters.put(AbstractSureTaxRequestTask.CLIENT_NUMBER,
				PLUGIN_PARAM_SURETAX_CLIENT_NUMBER);
		parameters.put(AbstractSureTaxRequestTask.VALIDATION_KEY,
				PLUGIN_PARAM_SURETAX_VALIDATION_KEY);
		parameters.put(AbstractSureTaxRequestTask.DATA_YEAR,
				PLUGIN_PARAM_DATA_YEAR);
		parameters.put(AbstractSureTaxRequestTask.DATA_MONTH,
