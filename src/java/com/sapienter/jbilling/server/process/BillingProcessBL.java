...
public class BillingProcessBL extends ResultList implements ProcessSQL {
    ...
    public InvoiceDTO[] generateInvoice(BillingProcessDTO process, TimePeriod dueDatePeriod, UserDTO user,
        ...
        AboutToGenerateInvoices event = new AboutToGenerateInvoices(entityId, userId, new Date(process.getBillingDate().getTime()), process);
    ...
    private void createOrderProcess(NewInvoiceContext newInvoice,
        ...
        for (NewInvoiceContext.OrderContext orderCtx : newInvoice.getOrders()) {
            ...
            Date lastPeriodStartDate = periodsList.get(periodsList.size() - 1).getStart();
            ...
            try {
                ...
                orderProcess.setLastPeriodStartDate(lastPeriodStartDate);
    ...
    public int getLast(Integer entityId) throws Exception {
        return billingProcessDas.getLastBillingProcessId(entityId) ;
    }
    ...
    /**
     * get generated Invoice counts using billing process Id FOR AGL
     * @param billingProcessId
     * @return
     */
    public BigInteger getSPCInvoiceCountForBillRun(Integer billingProcessId,boolean isAGLExtract) {
        return billingProcessId != null ? billingProcessDas.getSPCInvoiceCountForBillRun(billingProcessId,isAGLExtract) : BigInteger.valueOf(0);
    }

    /**
     * get estimated emails that would be sent from Bill Run
     * 
     * @param billingProcessId
     * @return
     */
    public int getEmailsEstimatedCount(Integer billingProcessId) {
        return billingProcessId != null ? billingProcessDas.getEmailsEstimatedCount(billingProcessId) : 0;
    }

    /**
     * get total emails sent from Bill Run
     * 
     * @param billingProcessId
     * @return
     */
    public int getEmailsSentCount(Integer billingProcessId, Integer jobExecutionId) {
        return billingProcessId != null ? billingProcessDas.getEmailsSentCount(billingProcessId, jobExecutionId) : 0;
    }

    /**
     * get total emails failed from Bill Run
     * 
     * @param billingProcessId
     * @return
     */
    public int getEmailsFailedCount(Integer billingProcessId, Integer jobExecutionId) {
        return billingProcessId != null ? billingProcessDas.getEmailsFailedCount(billingProcessId, jobExecutionId) : 0;
    }
    ...
    public List<InvoiceEmailProcessInfoDTO> getAllInvoiceEmailProcessInfo(Integer billingProcessId) {
        return billingProcessId != null ? billingProcessDas.getAllInvoiceEmailProcessInfo(billingProcessId) : null;
    }
}