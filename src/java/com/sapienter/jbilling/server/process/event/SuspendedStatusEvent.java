...
/**
 * This event is triggered when a user's suspended.
 *
 * @author Leandro Zoi
 * @since 01/15/18
 */
public class SuspendedStatusEvent implements Event {
    ...
    public SuspendedStatusEvent(UserDTO user, Date date, Integer entityId, String userLoggedName,
