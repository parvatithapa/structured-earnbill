...
public class SuretaxDeleteInvoiceTask extends PluggableTask implements
	...
	private static final FormatLogger LOG = new FormatLogger(
			Logger.getLogger(SuretaxDeleteInvoiceTask.class));
	...
	public void process(Event event) throws PluggableTaskException {
		...
		String transId = (String) deletingInvoice.getMetaField(
				AbstractSureTaxRequestTask.SURETAX_TRANS_ID_META_FIELD_NAME)
				.getValue();
