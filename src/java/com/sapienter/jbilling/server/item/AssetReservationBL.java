...
public class AssetReservationBL {
    ...
    private static final FormatLogger LOG = new FormatLogger(Logger.getLogger(AssetReservationBL.class));
    ...
    public void releaseAsset(Integer assetId, Integer creatorId, Integer userId) throws SessionInternalError {
        ...
        if (isValidToRelease) {
            activeReservation.setEndDate(TimezoneHelper.serverCurrentDate());
            try {
