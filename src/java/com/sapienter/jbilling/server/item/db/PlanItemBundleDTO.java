...
// todo: cache config
public class PlanItemBundleDTO implements Serializable, Auditable {
    ...
    public boolean hasQuantity() {
    	return this.quantity != null &&
    		this.quantity.compareTo(new BigDecimal(0.00)) > 0;
    }
    ...
    public String getAuditKey(Serializable id) {
        // todo: this class needs a back-reference so we can tie it back to the plan item & owning entity
        return id.toString();
    }
}
