...
public class DiscountDTO extends AbstractDescription implements Exportable{
	...
	@Column(name = "apply_to_all_periods")
	...
	public BigDecimal getDiscountAmount(BigDecimal applicableAmount) {
		...
		return (null == discountAmount) ? BigDecimal.ZERO : discountAmount.setScale(Constants.BIGDECIMAL_SCALE, Constants.BIGDECIMAL_ROUND);
	}
