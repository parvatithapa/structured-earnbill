...
public class NewActiveUntilEvent implements Event {
    ...
    private final Date newActiveUntil;
    private final Date oldActiveUntil;
    private final Date newActiveSince;
    private Integer orderType;
    private Integer statusId;
    
    public NewActiveUntilEvent(Integer orderId, 
            Date newActiveUntil, Date oldActiveUntil, Date newActiveSince) {
        try {
        ...
        this.newActiveSince = newActiveSince;
    }
    ...
    public Date getNewActiveSince() {
		return newActiveSince;
	}
