...
public class NewQuantityEvent implements Event {
    ...
    public NewQuantityEvent(Integer entityId, BigDecimal oldQuantity,
            ...
            OrderLineDTO newOrderLine, boolean isPlanSwap) {
    ...
    public String toString() {
        return getName() + " - entity " + entityId + " new order line " + (newOrderLine!=null ? newOrderLine.getId() : "null") +
                " new Quantity " + newQuantity + " old Quantity " + oldQuantity +
                " order line " + (orderLine !=null ? orderLine.getId() : "null");
    }
