...
public class ProvisioningProcessBL {
     ...
     */
    public void activateOrders(Integer entityId) {
        OrderDAS orders = new OrderDAS();

        // get list of orders where OrderDTO.activeSince <= today <OrderDTO.activeUntil
        List<OrderDTO> toActivateOrders = orders.findToActivateOrders(TimezoneHelper.companyCurrentDate(entityId));
     ...
     */
    public void deActivateOrders(Integer entityId) {
        OrderDAS orders = new OrderDAS();

        // get list of orders where OrderDTO.activeSince > today || OrderDTO.activeUntil <= today
        List<OrderDTO> toDeActivateOrders = orders.findToDeActiveOrders(TimezoneHelper.companyCurrentDate(entityId));
