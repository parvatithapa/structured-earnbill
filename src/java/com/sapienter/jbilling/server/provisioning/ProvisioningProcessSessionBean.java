...
public class ProvisioningProcessSessionBean 
    ...
    public void trigger(Integer entityId) throws SessionInternalError {
        LOG.debug("calling ProvisioningProcessSessionBean trigger() method");

        try {
            ProvisioningProcessBL processBL = new ProvisioningProcessBL();

            processBL.activateOrders(entityId);
            processBL.deActivateOrders(entityId);
        } catch (Exception e) {
    ...
    public void updateProvisioningStatus(Integer in_order_id, Integer in_order_line_id, String result)
    	...
    	LOG.debug("Updating provisioning status of order #" + in_order_id + " , order line # " + in_order_line_id + " where result is # " + result);
        ...
        LOG.debug("Updated provisioning status of line # " + in_order_line_id);
