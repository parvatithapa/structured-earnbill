...
public class PaymentAuthorizeNetTask extends PluggableTask
            ...
            if (method == 1) {
                if (paymentInfo.getIsRefund() == 0) {
                    data = getChargeData(login, transaction, isTest, 
                            ...
                            piBl.getCharMetaFieldByType(paymentInfo.getInstrument(), MetaFieldType.PAYMENT_CARD_NUMBER), expiry,
    ...
    */
    ...
    public NameValuePair[] getChargeData(String login, 
            String transaction, boolean test, BigDecimal amount, char[] cc_number,
        ...
        NameValuePair[] data = {
            ...
            new NameValuePair("x_Card_Num", new String(cc_number)),
    ...
    private NameValuePair[] getACHChargeData(String login, 
            String transaction, boolean test, BigDecimal amount,char[] aba,
            char[] account,
        ...
        NameValuePair[] data = {
            ...
            new NameValuePair("x_Tran_Key", transaction),
            new NameValuePair("x_Amount", amount.toString()),
            new NameValuePair("x_bank_aba_code", new String(aba)),
            new NameValuePair("x_bank_acct_num", new String(account)),
    ...
    public boolean preAuth(PaymentDTOEx payment)
        ...
        try {
            ...
            NameValuePair data[] = getChargeData(login, transaction, isTest,
                    payment.getAmount(), piBl.getCharMetaFieldByType(payment.getInstrument(), MetaFieldType.PAYMENT_CARD_NUMBER),
