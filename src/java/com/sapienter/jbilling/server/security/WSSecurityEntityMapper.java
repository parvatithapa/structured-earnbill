 ...
 *
 * @see com.sapienter.jbilling.server.security.WSSecurityCheck
 *
...
public class WSSecurityEntityMapper {
    ...
    private static WSSecured fromPlanWS(PlanWS ws) {
        ...
        return null; // A Plan may not be owned by the caller company only. Plan is now a shared/shareable entity
    }
