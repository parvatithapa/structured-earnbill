 ...
 *
 * Prices the item at $0/unit. Zero pricing assumes that the user has already paid for all
 * usage as part of the cost of the plan.
 *
 * @author Brian Cowdery
 * @since 05-08-2010
 */
public class ZeroPricingStrategy extends AbstractPricingStrategy {

    public ZeroPricingStrategy() {
        setChainPositions(
                ChainPosition.START
        );
