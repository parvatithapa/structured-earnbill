...
public interface PricingStrategy {
    ...
    /**
     * Returns true if strategy calculate price based on usage or price may varies on 
     * the basis of Usage or Quantity 
     * @return true if strategy calculate price based on usage or quantity.
     */
    public boolean isVariableUsagePricing();
    
    /**
     * Used to determine if the current pricing strategy requires dynamic attributes in the UI.
     *
     * @return true if the dynamic attributes are required, false otherwise.
     */
     ...
     */
    default public void validate(PriceModelDTO priceModel) {};
}
