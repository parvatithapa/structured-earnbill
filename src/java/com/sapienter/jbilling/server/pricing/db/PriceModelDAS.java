...
public class PriceModelDAS extends AbstractDAS<PriceModelDTO> {
    ...
    private static final String findCompanySQL =
            "SELECT * " +
            "  FROM PriceModelDTO a " +
            " WHERE a.company.id = :company ";
    ...
    public List findPriceModelsByCompany(Integer companyId){
        Query query = getSession().createQuery(findCompanySQL);
