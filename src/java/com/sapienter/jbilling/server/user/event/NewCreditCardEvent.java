 ...
 * @author emilc
 */
public class NewCreditCardEvent implements Event, AutoCloseable {
    ...
    public NewCreditCardEvent(PaymentInformationDTO creditCard, Integer entityId, Integer userId) {
