...
public abstract class AbstractValidatePurchaseTask extends PluggableTask implements IValidatePurchaseTask {
    private static final Logger LOG = Logger.getLogger(AbstractValidatePurchaseTask.class);
     ...
     */
    protected class PurchaseContext {
        ...
        public PurchaseContext(Integer userId, BigDecimal totalCost) {
            ...
            this.currentOrder = new OrderBL().getCurrentOrder(userId, companyCurrentDate());
            this.plan = new PlanBL();
        ...
        public boolean isSubscribed(Integer itemId) {
            return plan.isSubscribed(userId, itemId, companyCurrentDate());
        }
