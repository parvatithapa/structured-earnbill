...
package com.sapienter.jbilling.server.user.tasks.ws;
 ...
 * generated in the com.sapienter.jbilling.server.user.tasks.ws package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sapienter.jbilling.server.user.tasks.ws
     * 
     */
