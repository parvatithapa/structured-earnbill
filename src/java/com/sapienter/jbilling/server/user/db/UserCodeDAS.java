...
public class UserCodeDAS extends AbstractDAS<UserCodeDTO> {
    ...
    public List<UserCodeDTO> findActiveForUser(int userId) {
        ...
        query.setInteger("user_id", userId);
        query.setDate("a_date", TimezoneHelper.companyCurrentDateByUserId(userId));
        return query.list();
    }
    ...
    public List<UserCodeDTO> findActiveForPartner(ArrayList userIds) {
        ...
        query.setDate("a_date", TimezoneHelper.companyCurrentDateByUserId(userIds != null ? (Integer) userIds.get(0) : null));
        return query.list();
    }
