...
public class PaypalApi {
    ...
    public PaypalResult doDirectPayment(
        ...
        encoder.add("CREDITCARDTYPE", new String(creditCard.getType()));
        encoder.add("ACCT", new String(creditCard.getAccount()));
        encoder.add("EXPDATE", new String(creditCard.getExpirationDate()));
        encoder.add("CVV2", creditCard.getCvv2()!=null? new String(creditCard.getCvv2()): null);
        ...
        if(null != payer){
            ...
            encoder.add("STREET2", payer.getStreet2());
            ...
            encoder.add("EMAIL", payer.getEmail());
        }
        ...
        if(decoder.get("ACK").equals("Failure")) {
            ...
            result.setErrMsg(decoder.get("L_SHORTMESSAGE0"));
            return result;
    ...
    public PaypalResult doReferenceTransaction(
            char[] transactionId, PaymentAction paymentAction, Payer payer,  Payment payment)
            throws PayPalException {
        ...
        encoder.add("REFERENCEID", new String(transactionId));
        encoder.add("PAYMENTACTION", paymentAction.toString());
    ...
    public PaypalResult refundTransaction(char[] transactionId, String amount, RefundType refundType)
            throws PayPalException {
        ...
        encoder.add("TRANSACTIONID", new String(transactionId));
