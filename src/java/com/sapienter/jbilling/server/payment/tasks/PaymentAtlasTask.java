    ...
    private Map<String, Object> getData(PaymentDTOEx paymentInfo)
        ...
        if (paymentInfo.getUserId() != null)
            data.put("customerAccountCode", String.valueOf(paymentInfo
                    .getUserId()));
        data.put("accountNumber", piBl.getCharMetaFieldByType(paymentInfo.getInstrument(), MetaFieldType.PAYMENT_CARD_NUMBER));
        data.put("name", piBl.getCharMetaFieldByType(paymentInfo.getInstrument(), MetaFieldType.TITLE));
