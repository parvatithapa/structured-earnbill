 ...
 */
public class ProductDefaultPriceDownloadReader implements ItemReader<ItemDTOEx>, ItemStreamReader<ItemDTOEx>, StepExecutionListener {
    ...
    private ItemDTOEx[] allItemsByEntityId;
    ...
    public void beforeStep(StepExecution stepExecution) {
        ...
        productCode = jobParameters.getString(ProductImportConstants.JOB_PARAM_IDENTIFICATION_CODE);
    ...
    @Override
    public ItemDTOEx read() throws Exception{
        try (RunAsUser ctx = new RunAsCompanyAdmin(entityId)) {

            try {
                if(StringUtils.isNotBlank(productCode) && !itemProcessed) {

                    Integer itemId = webServicesSessionBean.getItemID(productCode);

                    if(itemId != null){

                        ItemDTOEx item = webServicesSessionBean.getItem(itemId, null, null);
                        itemProcessed = true;
                ...
                }else if(allItemsByEntityId != null && arrayIndex < allItemsByEntityId.length) {

                    ItemDTOEx itemDTOEx = allItemsByEntityId[arrayIndex++];
    ...
    public void open(ExecutionContext executionContext) throws ItemStreamException {
        ...
        if(StringUtils.isBlank(productCode)) {
            ...
            allItemsByEntityId = webServicesSessionBean.getAllItemsByEntityId(this.entityId);
        }
    }
