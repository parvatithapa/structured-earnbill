...
public class JBillingPasswordEncoder implements PasswordEncoder {
	...
	@Resource(name = "jbillingUserService")
	 ...
	 */
	@Override
	public String encodePassword(String password, Object companyUserDetails) {
	...
	public boolean isPasswordValid(String encPass, String rawPass, Object companyUserDetails) {
		Boolean match = false;

		Integer configPassEncoderId = Integer.parseInt(Util.getSysProp(Constants.PASSWORD_ENCRYPTION_SCHEME));

		if (companyUserDetails instanceof CompanyUserDetails) {
	...
	private Integer getPasswordEncoderId(Object salt) {
		...
		if (salt instanceof CompanyUserDetails) {
