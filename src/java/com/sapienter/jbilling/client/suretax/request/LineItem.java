...
public class LineItem {
	...
	public static LineItem getCopy(LineItem object) {
		LineItem newObject = new LineItem();
		newObject.lineNumber = object.lineNumber;
		newObject.invoiceNumber = object.invoiceNumber;
		newObject.customerNumber = object.customerNumber;
		newObject.origNumber = object.origNumber;
		newObject.termNumber = object.termNumber;
		newObject.billToNumber = object.billToNumber;
		newObject.zipcode = object.zipcode;
		newObject.plus4 = object.plus4;
		newObject.p2PZipcode = object.p2PZipcode;
		newObject.p2PPlus4 = object.p2PPlus4;
		newObject.transDate = object.transDate;
		newObject.revenue = object.revenue;
		newObject.units = object.units;
		newObject.unitType = object.unitType;
		newObject.seconds = object.seconds;
		newObject.taxIncludedCode = object.taxIncludedCode;
		newObject.taxSitusRule = object.taxSitusRule;
		newObject.transTypeCode = object.transTypeCode;
		newObject.salesTypeCode = object.salesTypeCode;
		newObject.regulatoryCode = object.regulatoryCode;
		newObject.taxExemptionCodeList = new ArrayList<String>(object.taxExemptionCodeList);
		return newObject;
	}
