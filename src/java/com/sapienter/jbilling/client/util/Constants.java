...
public final class Constants implements PermissionConstants, CommonConstants {
    ...
    * */
    ...
    //Report parameter's date format
    public static final String REPORT_INPUT_DATE_FORMAT="MM/dd/yyyy";

    // CSV Types
    public static final String ORDER_CSV="Orders";
    public static final String USER_CSV="Users";
