...
target(generateLbJar: "Generates a JAR with all customChange class dependencies") {
    ...
    //AbstractCustomSqlChange is extended by some custom migration classes, but is not in the upgrade-*** files
    def classes = ["com.sapienter.jbilling.server.migrations.AbstractCustomSqlChange"]
