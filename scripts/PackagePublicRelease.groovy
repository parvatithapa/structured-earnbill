...
target(updateImage: "Updates the jbilling image with the current release artifacts.") {
	...
	delete(dir: "${jbillingHome}/resources/invoiceTemplates", includes: "**/*")
	copy(todir: "${jbillingHome}/resources/invoiceTemplates") {
		fileset(dir: "${resourcesDir}/invoiceTemplates")
	}
	...
	// copy mediation
	delete(dir: "${jbillingHome}/resources/mediation", includes: "**/*")
	copy(todir: "${jbillingHome}/resources/mediation") {
		fileset(dir: "${resourcesDir}/mediation")
	}
